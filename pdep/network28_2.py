...
species(
    ...
    E0 = (481.159,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([180,337.551,975.972,975.979,976.274,3290.48],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (58.1869,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(920.412,'J/mol'), sigma=(4.443e-10,'m'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with fixed Lennard Jones Parameters. This is the fallback method! Try improving transport databases!"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.19112,0.0144821,-1.50504e-05,7.47318e-09,-1.37976e-12,57902,11.7166], Tmin=(100,'K'), Tmax=(1497.39,'K')), NASAPolynomial(coeffs=[7.55626,0.00109544,8.86786e-08,-3.67961e-11,2.61059e-15,56788.3,-10.4588], Tmin=(1497.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(481.159,'kJ/mol'), comment="""Thermo library: SiliconHydrideLibrary + radical(SisJ_SiLP) + radical(SiJ_LP_Si)"""),
)

species(
    label = '[SiH2][Si][SiH2](62)',
    structure = SMILES('[SiH2][Si][SiH2]'),
    E0 = (518.134,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction2',
    reactants = ['[SiH2][Si]=[SiH2](58)', '[H](21)'],
    products = ['[SiH2][SiH]=[SiH2](37)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[SiH]=[SiH][SiH2](59)', '[H](21)'],
    products = ['[SiH2][SiH]=[SiH2](37)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.20571e+06,'m^3/(mol*s)'), n=0.100587, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template (Y_rad;Y_rad) for rate rule (Si_rad;H_rad)
Ea raised from -0.8 to 0 kJ/mol."""),
...
reaction(
    label = 'reaction6',
    reactants = ['[Si]=[SiH][SiH2](29)', 'H2(13)'],
    products = ['[SiH2][SiH]=[SiH2](37)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['SiH3(4)', '[Si][SiH2](61)'],
    products = ['[SiH2][Si][SiH3](41)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[H](21)', '[SiH2][Si][SiH2](62)'],
    products = ['[SiH2][Si][SiH3](41)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H2(13)', '[SiH][Si][SiH2](47)'],
    products = ['[SiH2][Si][SiH3](41)'],
