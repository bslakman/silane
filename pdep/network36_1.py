...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(1971.36,'J/mol'), sigma=(5.118e-10,'m'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with fixed Lennard Jones Parameters. This is the fallback method! Try improving transport databases!"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53549,0.05799,-8.46089e-05,6.79288e-08,-2.19234e-11,48192,19.4179], Tmin=(100,'K'), Tmax=(793.019,'K')), NASAPolynomial(coeffs=[8.64302,0.0202312,-9.5782e-06,1.81829e-09,-1.2534e-13,47124.7,-12.8452], Tmin=(793.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.983,'kJ/mol'), comment="""Thermo group additivity estimation: group(Sis-H2Si2) + other(R) + group(Sis-H3Si) + other(R) + group(Sis-H3Si) + other(R) + radical(SisJ_Si2_H) + radical(SisJ_Si_H2)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[SiH2][SiH][SiH3](51)', '[H](21)'],
    products = ['[SiH2][SiH2][SiH3](23)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[SiH2][SiH2][SiH2](50)', '[H](21)'],
    products = ['[SiH2][SiH2][SiH3](23)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2(13)', '[SiH2][Si][SiH3](41)'],
    products = ['[SiH2][SiH2][SiH3](23)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[SiH][SiH2][SiH2](52)', 'H2(13)'],
    products = ['[SiH2][SiH2][SiH3](23)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[Si][SiH2][SiH3](53)', 'H2(13)'],
    products = ['[SiH2][SiH2][SiH3](23)'],
    transitionState = 'TS7',
