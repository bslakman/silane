...
species(
    ...
    E0 = (695.052,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([247.872,250.343,251.599,255.012,255.475,256.683,904.464,1533.41],'cm^-1')),
        HinderedRotor(inertia=(0.0369471,'amu*angstrom^2'), symmetry=1, barrier=(61.7908,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.2724,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(1971.36,'J/mol'), sigma=(5.118e-10,'m'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with fixed Lennard Jones Parameters. This is the fallback method! Try improving transport databases!"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27382,0.0438969,-8.57512e-05,7.80862e-08,-2.62337e-11,83652.1,15.7593], Tmin=(100,'K'), Tmax=(904.488,'K')), NASAPolynomial(coeffs=[6.86486,0.0092975,-4.66306e-06,8.4427e-10,-5.40992e-14,83406.3,-2.69627], Tmin=(904.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(695.052,'kJ/mol'), comment="""Thermo group additivity estimation: group(Sis-H3Si) + other(R) + group(si-Sis-si) + other(R) + group(si-Sis-H) + other(R) + radical(SisJ_SiLP) + radical(SiJ_LP_H)"""),
)
...
species(
    ...
    E0 = (774.811,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([346.765,347.022,347.239,347.346,347.503],'cm^-1')),
        HinderedRotor(inertia=(0.616329,'amu*angstrom^2'), symmetry=1, barrier=(52.5446,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.2644,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(1971.36,'J/mol'), sigma=(5.118e-10,'m'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with fixed Lennard Jones Parameters. This is the fallback method! Try improving transport databases!"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49304,0.0390607,-8.11598e-05,7.545e-08,-2.56482e-11,93237,13.1609], Tmin=(100,'K'), Tmax=(900.819,'K')), NASAPolynomial(coeffs=[6.54726,0.00684402,-3.84515e-06,7.1532e-10,-4.61473e-14,93083.3,-2.7738], Tmin=(900.819,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(774.811,'kJ/mol'), comment="""Thermo group additivity estimation: group(si-si2) + other(R) + group(si-Sis-H) + other(R) + group(si-Sis-H) + other(R) + radical(SiJ_LP_H)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['SiH3(3)', '[Si][Si](52)'],
    products = ['[Si][Si][SiH3](40)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[Si][SiH2](55)', 'SiH(11)'],
    products = ['[SiH][Si][SiH2](42)'],
