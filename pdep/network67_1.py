...
reaction(
    label = 'reaction3',
    reactants = ['H2(3)', '[SiH2][Si]=[SiH2](88)'],
    products = ['[SiH2][Si]=[SiH2](78)'],
    transitionState = 'TS3',
