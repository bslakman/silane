...
reaction(
    label = 'reaction1',
    reactants = ['SiH4(1)', '[SiH]=[SiH2](20)'],
    products = ['[SiH]=[SiH][SiH3](25)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['H2(3)', '[SiH]=[SiH][SiH3](44)'],
    products = ['[SiH]=[SiH][SiH3](25)'],
    transitionState = 'TS5',
