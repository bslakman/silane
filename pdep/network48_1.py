...
reaction(
    label = 'reaction1',
    reactants = ['SiH(10)', '[SiH]=[SiH2](20)'],
    products = ['[SiH2][Si]=[SiH2](56)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['H2(3)', '[SiH2][Si]=[SiH2](68)'],
    products = ['[SiH2][Si]=[SiH2](56)'],
    transitionState = 'TS3',
