...
reaction(
    label = 'reaction1',
    reactants = ['SiH4(1)', '[SiH]=[SiH2](22)'],
    products = ['[SiH]=[SiH][SiH3](31)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[H](13)', '[SiH]=[SiH][SiH2](58)'],
    products = ['[SiH]=[SiH][SiH3](31)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H2(3)', '[SiH]=[SiH][SiH3](60)'],
    products = ['[SiH]=[SiH][SiH3](31)'],
    transitionState = 'TS5',
