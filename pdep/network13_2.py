...
reaction(
    label = 'reaction3',
    reactants = ['[H](13)', '[SiH2][SiH]=[SiH2](23)'],
    products = ['[SiH2]=[SiH][SiH3](16)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[H](13)', '[SiH2]=[Si][SiH3](24)'],
    products = ['[SiH2]=[SiH][SiH3](16)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(7.20571e+06,'m^3/(mol*s)'), n=0.100587, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template (Y_rad;Y_rad) for rate rule (Si_rad;H_rad)
Ea raised from -0.8 to 0 kJ/mol."""),
...
reaction(
    label = 'reaction5',
    reactants = ['[H](13)', '[SiH]=[SiH][SiH3](25)'],
    products = ['[SiH2]=[SiH][SiH3](16)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(7.20571e+06,'m^3/(mol*s)'), n=0.100587, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template (Y_rad;Y_rad) for rate rule (Si_rad;H_rad)
Ea raised from -0.8 to 0 kJ/mol."""),
...
reaction(
    label = 'reaction7',
    reactants = ['H2(3)', '[SiH2]=[SiH][SiH3](27)'],
    products = ['[SiH2]=[SiH][SiH3](16)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['SiH3(9)', '[SiH2][SiH3](18)'],
    products = ['[SiH3][SiH2][SiH3](26)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.20571e+06,'m^3/(mol*s)'), n=0.100587, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template (Y_rad;Y_rad) for rate rule (Si_rad;Si_silyl)
Ea raised from -0.8 to 0 kJ/mol."""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[H](13)', '[SiH2][SiH2][SiH3](40)'],
    products = ['[SiH3][SiH2][SiH3](26)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H2(3)', '[SiH3][SiH2][SiH3](41)'],
    products = ['[SiH3][SiH2][SiH3](26)'],
