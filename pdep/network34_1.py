...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(1971.36,'J/mol'), sigma=(5.118e-10,'m'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with fixed Lennard Jones Parameters. This is the fallback method! Try improving transport databases!"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.54053,0.0384077,-7.84009e-05,7.38123e-08,-2.53692e-11,97116.4,24.5987], Tmin=(100,'K'), Tmax=(907.515,'K')), NASAPolynomial(coeffs=[5.52973,0.00960792,-4.97375e-06,9.01022e-10,-5.76197e-14,97217.3,14.0124], Tmin=(907.515,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(807.084,'kJ/mol'), comment="""Thermo group additivity estimation: group(Sid-Sid-H2) + other(R) + group(si-Sid-H) + other(R) + group(si-Sid-H) + other(R) + radical(SiJ_LP_Si) + radical(SidsJ_Si)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[Si][Si]=[Si](48)', '[H](21)'],
    products = ['[Si][SiH]=[Si](46)'],
    transitionState = 'TS1',
