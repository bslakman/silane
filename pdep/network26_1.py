species(
    ...
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.374,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4418.31,'J/mol'), sigma=(4.687e-10,'m'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with fixed Lennard Jones Parameters. This is the fallback method! Try improving transport databases!"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.279499,0.0927827,-0.000174895,1.56682e-07,-5.24842e-11,51584.3,-4.01467], Tmin=(100,'K'), Tmax=(888.373,'K')), NASAPolynomial(coeffs=[10.942,0.0200684,-1.04037e-05,1.93747e-09,-1.27696e-13,50664.8,-48.7059], Tmin=(888.373,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.869,'kJ/mol'), comment="""Thermo group additivity estimation: group(Sis-Sis4) + other(R) + group(Sid-H2) + other(R) + group(Sis-Sis4) + other(R) + group(si) + other(R)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[SiH2]=[SiH2](15)', '[SiH2]=[SiH2](15)'],
    products = ['[SiH2]=[SiH][SiH]=[SiH2](28)'],
    transitionState = 'TS1',
...
network(
    label = '26',
    isomers = [
        '[SiH2]=[SiH][SiH]=[SiH2](28)',
    ],
    reactants = [
        ('[SiH2]=[SiH2](15)', '[SiH2]=[SiH2](15)'),
    ],
    bathGas = {
        'He': 0.25,
        'Ar': 0.25,
