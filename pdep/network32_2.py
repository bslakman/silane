...
species(
    ...
    collisionModel = TransportData(shapeIndex=1, epsilon=(920.412,'J/mol'), sigma=(4.443e-10,'m'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with fixed Lennard Jones Parameters. This is the fallback method! Try improving transport databases!"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.42864,0.0138319,-2.96205e-05,2.47363e-08,-7.28089e-12,73599.9,4.31955], Tmin=(100,'K'), Tmax=(1018.84,'K')), NASAPolynomial(coeffs=[6.30504,-0.0023628,1.43891e-06,-3.09209e-10,2.3394e-14,73268.2,-8.36261], Tmin=(1018.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(611.783,'kJ/mol'), comment="""Thermo library: SiliconHydrideLibrary + radical(SiJ_LP_H) + radical(SiJ_LP_H)"""),
)
...
species(
    ...
    E0 = (676.828,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([362.327,362.441,362.479,362.533,362.568,362.583,362.901,1569.35],'cm^-1')),
        HinderedRotor(inertia=(0.0366849,'amu*angstrom^2'), symmetry=1, barrier=(64.0574,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.2724,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(1971.36,'J/mol'), sigma=(5.118e-10,'m'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with fixed Lennard Jones Parameters. This is the fallback method! Try improving transport databases!"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29369,0.0414709,-7.54868e-05,6.47581e-08,-2.07731e-11,81461.3,15.7887], Tmin=(100,'K'), Tmax=(910.059,'K')), NASAPolynomial(coeffs=[7.9917,0.00705812,-3.32498e-06,5.84277e-10,-3.67047e-14,80812.1,-9.03254], Tmin=(910.059,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(676.828,'kJ/mol'), comment="""Thermo group additivity estimation: group(Sis-H3Si) + other(R) + group(si-Sis-si) + other(R) + group(si-Sis-H) + other(R) + radical(SisJ_SiLP) + radical(SiJ_LP_H)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['SiH3(4)', '[Si][Si](54)'],
    products = ['[Si][Si][SiH3](44)'],
    transitionState = 'TS9',
