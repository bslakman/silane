...
species(
    ...
    E0 = (526.701,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([402.895,402.899,402.903],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (57.1789,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(920.412,'J/mol'), sigma=(4.443e-10,'m'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with fixed Lennard Jones Parameters. This is the fallback method! Try improving transport databases!"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.28611,0.0173351,-3.29398e-05,2.79125e-08,-8.64305e-12,63371.7,7.37709], Tmin=(100,'K'), Tmax=(955.192,'K')), NASAPolynomial(coeffs=[5.99855,0.00128366,-3.6386e-07,3.31061e-11,-1.0541e-16,63067.6,-4.4639], Tmin=(955.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(526.701,'kJ/mol'), comment="""Thermo library: SiliconHydrideLibrary + radical(SiJ_LP_H)"""),
)
...
species(
    label = '[SiH][Si][SiH](70)',
    structure = SMILES('[SiH][Si][SiH]'),
    E0 = (668.376,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([374.574,374.574,374.574,374.574,374.574,374.575,2297.83],'cm^-1')),
        HinderedRotor(inertia=(0.0121894,'amu*angstrom^2'), symmetry=1, barrier=(45.6712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458711,'amu*angstrom^2'), symmetry=1, barrier=(45.6712,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.2724,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(1971.36,'J/mol'), sigma=(5.118e-10,'m'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with fixed Lennard Jones Parameters. This is the fallback method! Try improving transport databases!"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34619,0.0425471,-8.43598e-05,7.86637e-08,-2.71597e-11,80440.8,14.858], Tmin=(100,'K'), Tmax=(884.435,'K')), NASAPolynomial(coeffs=[6.30914,0.0103637,-5.5914e-06,1.05952e-09,-7.05516e-14,80297.5,-0.621242], Tmin=(884.435,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(668.376,'kJ/mol'), comment="""Thermo group additivity estimation: group(si-si2) + other(R) + group(si-Sis-H) + other(R) + group(si-Sis-H) + other(R)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['SiH4(3)', '[Si]=[Si](37)'],
    products = ['[Si]=[SiH][SiH3](39)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction8',
    reactants = ['SiH3(5)', '[Si][SiH](57)'],
    products = ['[SiH][Si][SiH3](28)'],
    transitionState = 'TS8',
