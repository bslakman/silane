...
reaction(
    label = 'reaction4',
    reactants = ['H2(13)', '[SiH3][Si][SiH3](24)'],
    products = ['Si3H8(3)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[H](21)', '[SiH3][SiH][SiH3](22)'],
    products = ['Si3H8(3)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction3',
    reactants = ['[H](21)', '[SiH2][SiH2][SiH3](23)'],
    products = ['Si3H8(3)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(7.20571e+06,'m^3/(mol*s)'), n=0.100587, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template (Y_rad;Y_rad) for rate rule (Si_rad;H_rad)
Ea raised from -0.8 to 0 kJ/mol."""),
...
reaction(
    label = 'reaction5',
    reactants = ['SiHSiH2SiH3(10)', 'H2(13)'],
    products = ['Si3H8(3)'],
    transitionState = 'TS5',
...
network(
    ...
    reactants = [
        ('H2(13)', '[SiH3][Si][SiH3](24)'),
        ('SiH3(4)', 'Si2H5(5)'),
        ('SiHSiH2SiH3(10)', 'H2(13)'),
        ('SiH4(1)', 'SiH3SiH(7)'),
        ('SiH2(6)', 'Si2H6(2)'),
    ],
    bathGas = {
