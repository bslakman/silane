...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(1971.36,'J/mol'), sigma=(5.118e-10,'m'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with fixed Lennard Jones Parameters. This is the fallback method! Try improving transport databases!"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53548,0.0579901,-8.46094e-05,6.79296e-08,-2.19238e-11,48192,19.418], Tmin=(100,'K'), Tmax=(792.997,'K')), NASAPolynomial(coeffs=[8.64304,0.0202311,-9.57818e-06,1.81829e-09,-1.25339e-13,47124.7,-12.8453], Tmin=(792.997,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.983,'kJ/mol'), comment="""Thermo group additivity estimation: group(Sis-H2Si2) + other(R) + group(Sis-H3Si) + other(R) + group(Sis-H3Si) + other(R) + radical(SisJ_Si_H2) + radical(SisJ_Si2_H)"""),
)

species(
    label = '[SiH2][SiH2][SiH2](52)',
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(1971.36,'J/mol'), sigma=(5.118e-10,'m'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with fixed Lennard Jones Parameters. This is the fallback method! Try improving transport databases!"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61502,0.0572446,-7.70443e-05,5.14198e-08,-1.14991e-11,49420.3,18.2114], Tmin=(100,'K'), Tmax=(648.329,'K')), NASAPolynomial(coeffs=[9.12745,0.019381,-9.07525e-06,1.71713e-09,-1.18341e-13,48267.9,-16.1516], Tmin=(648.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(410.227,'kJ/mol'), comment="""Thermo group additivity estimation: group(Sis-H2Si2) + other(R) + group(Sis-H3Si) + other(R) + group(Sis-H3Si) + other(R) + radical(SisJ_Si_H2) + radical(SisJ_Si_H2)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['Si2H6(4)', 'SiH(15)'],
    products = ['[SiH2][SiH2][SiH3](33)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[H](21)', '[SiH2][SiH][SiH3](53)'],
    products = ['[SiH2][SiH2][SiH3](33)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[H](21)', '[SiH2][SiH2][SiH2](52)'],
    products = ['[SiH2][SiH2][SiH3](33)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2(11)', '[SiH2][Si][SiH3](45)'],
    products = ['[SiH2][SiH2][SiH3](33)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[SiH][SiH2][SiH2](25)', 'H2(11)'],
    products = ['[SiH2][SiH2][SiH3](33)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[Si][SiH2][SiH3](26)', 'H2(11)'],
    products = ['[SiH2][SiH2][SiH3](33)'],
    transitionState = 'TS7',
