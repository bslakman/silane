...
reaction(
    label = 'reaction1',
    reactants = ['SiH4(1)', '[Si]=[SiH2](30)'],
    products = ['[Si]=[SiH][SiH3](31)'],
    transitionState = 'TS1',
